...
<%
	String title = "成绩管理注册表管理 - 内容管理", csspath	= "../include";	
%>
    ...
    <td valign="top">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr> 
          ...
          <td height="22" class="black"><b><font color="red"><%=area%></font></b>&nbsp;|&nbsp;内容管理&nbsp;&nbsp;<a href="javascript:if(confirm('请仔细检查，确认删除所有录入信息吗?')) window.location='delete.jsp?tid=<%=tid%>&type=all&id=0'" class="black">删除所有</a></td>
        </tr>
		<tr> 
          <td>&nbsp;</td>
          <td>
						...
						<td width="100%" valign="top">
						  <table width="100%" border="0" cellspacing="1" cellpadding="1">
							...
							<tr align="center" bgcolor="#ffffff">
                              ...
                              <td height="22" width="18%" class="black">学号</td>
							  <td height="22" width="20%" class="black">成绩</td>
							  <td height="22" width="20%" class="black">姓名</td>
...
<%
	...
	sql	= "select seq, xuehao,content,name,usedate, msgid from gzmy_meili_info order by usedate desc, seq desc";
	...
	if(rsCOM.getRows()!=0) {
		for(int i=0; i<num; i++) {
			...
			out.println("<td align=\"center\">" + rsCOM.get(i, 3) + "</td>");

			if (rsCOM.get(i, 4) != null && !rsCOM.get(i, 4).equals("null") && !rsCOM.get(i, 4).equals(""))
				out.println("<td align=\"center\">" + rsCOM.get(i, 4).substring(0, 10) + "</td>");
			else
				out.println("<td>&nbsp;</td>");

			out.println("<td align=\"center\"><a href=\"mody.jsp?tid=" + tid + "&id=" + rsCOM.get(i, 5) + "\">修改</a></td>");
			out.println("<td align=\"center\"><a href=\"javascript:if(confirm('确认删除吗?')) window.location='delete.jsp?tid=" + tid + "&type=single&id=" + rsCOM.get(i,5) + "'\">删除</a></td>");
...
%>
								  ...
								  <tr bgcolor="<%=Bgtitle%>" height="22">
								    <td colspan="7" class="white">&nbsp;&gt;&nbsp;『成绩管理』&nbsp;-&nbsp;信息录入</td>
								  </tr>
								  <tr>
								    <td colspan="7"><hr noshade width="100%" size="1" color="#000000"></td>
								  </tr>
...
%>
                                    ...
                                    <tr height="22">
									<td colspan="3" class="black">
									  学号：<textarea name="xuehao" rows="1" cols="32" onchange="toInputContent1(this.value)"></textarea>
									</td>
								  ...
								  <tr height="22">
									<td colspan="3" class="black">
									  成绩：<textarea name="content" rows="1" cols="32" onchange="toInputContent1(this.value)"></textarea>
									</td>

                                    <td colspan="2" class="black">
									<tr height="22">
									<td colspan="3" class="black">
									  姓名：<textarea name="content1" rows="1" cols="32" onchange="toInputContent1(this.value)"></textarea>
									</td>
                                    
                                    
									<td colspan="2" class="black">
									  字数：<input type="text" name="contentLen" size="2" value="0" disabled>
									</td>
								  </tr>
								  <tr height="22">
									<td colspan="3" class="black">
...
%>
								  ...
								  <tr height="22">
									...
									<td colspan="2" class="black">
									  总共：<input type="text" name="totalLen" value="0" size="2" disabled>
									</td>
								  </tr>
								  </form>
